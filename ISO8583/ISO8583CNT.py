...
"""
	...
	_BITS_VALUE_TYPE[11] = ['11','Systems trace audit number','LL',60,'n']
	_BITS_VALUE_TYPE[12] = ['12','Date and time local transaction','N',6,'n']
	_BITS_VALUE_TYPE[13] = ['13','Fecha transaccion local','N',8,'n']
	...
	_BITS_VALUE_TYPE[18] = ['18','Message error indicator','AN',12,'an']
	...
	_BITS_VALUE_TYPE[28] = ['28','Date reconciliation','LL',8,'an']
	...
	_BITS_VALUE_TYPE[32] = ['32','Institucion adquiriente','N',6,'n']
	_BITS_VALUE_TYPE[33] = ['33','Forwarding institution identification code','N',3,'n']
	_BITS_VALUE_TYPE[34] = ['34','Electronic commerce data','LL',16,'an']
	_BITS_VALUE_TYPE[35] = ['35','Track 2 data','LL',37,'n']
	_BITS_VALUE_TYPE[36] = ['36','Track 3 data','LLL',104,'n']
	_BITS_VALUE_TYPE[37] = ['37','Retrieval reference number','N',12,'n']
	...
	_BITS_VALUE_TYPE[41] = ['41','Terminal','LL',16,'an']
	...
	_BITS_VALUE_TYPE[45] = ['45','Track 1 data','LL',35,'n']
	...
	_BITS_VALUE_TYPE[49] = ['49','Verification data','AN',3,'an']
	_BITS_VALUE_TYPE[50] = ['50','Currency code, settlement','AN',3,'an']
	_BITS_VALUE_TYPE[51] = ['51','Currency code, cardholder billing','LL',20,'an']
	_BITS_VALUE_TYPE[52] = ['52','Personal identification number (PIN) data','N',8,'n']
	_BITS_VALUE_TYPE[53] = ['53','Security related control information','N',16,'n']
	_BITS_VALUE_TYPE[54] = ['54','Amounts additional','N',16,'n']
	_BITS_VALUE_TYPE[55] = ['55','Integrated circuit card (ICC) system related data','N',16,'n']
	_BITS_VALUE_TYPE[56] = ['56','Original data elements','N',16,'n']
	_BITS_VALUE_TYPE[57] = ['57','Authorisation life cycle code','N',4,'n']
	_BITS_VALUE_TYPE[58] = ['58','Authorising agent institution identification code','N',8,'n']
	_BITS_VALUE_TYPE[59] = ['59','Transport data','N',2,'n']
	_BITS_VALUE_TYPE[60] = ['60','Reserved for national use','LLL',999,'ans']
	_BITS_VALUE_TYPE[61] = ['61','Reserved for national use','N',20,'n']
	_BITS_VALUE_TYPE[62] = ['62','Reserved for private use','LL',99,'ans']
	_BITS_VALUE_TYPE[63] = ['63','Reserved for private use','N',27,'n']
	...
	_BITS_VALUE_TYPE[69] = ['69','Settlement institution county code','LL',60,'an']
